    ...
    <section className="bg-gradient-to-b from-green-50 to-emerald-100 py-16 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <form
          ...
          className="flex  text-black flex-col sm:flex-row justify-center items-center gap-3 mb-10"
        >
          <input
            type="text"
            value={query}
        ...
        {loading ? (
          ...
          <>
            ...
            {visibleCount < filteredRecords.length && (
              <Link
                href="/grave"
                className="mt-10 inline-block bg-emerald-700 text-white px-6 py-2 rounded-full hover:bg-emerald-600 transition shadow-md"
              >
                View More
              </Link>
